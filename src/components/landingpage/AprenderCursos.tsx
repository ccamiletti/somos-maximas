                ...
                <SubCard>
                  <Grid container justifyContent="center" sx={{padding: '15px'}}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="64px" height="64px" viewBox="0 0 64 64">
                      <path fill="none" stroke="#000000" strokeWidth="2" strokeMiterlimit="10" d="M7,0L7,64" ></path>
                      <path fill="none" stroke="#000000" strokeWidth="2" strokeMiterlimit="10" d="M32.062,6L26,11L26,35L57,35L51,23L57,11L26,11"></path>
                      <path fill="none" stroke="#000000" strokeWidth="2" strokeMiterlimit="10" d="M26,30L7,30L7,6L32,6L32,11"></path>
                    </svg>
                    </Grid>
                    <Grid item xs={12}>
